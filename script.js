...
// Function to handle login (basic validation, actual implementation should be more secure)
function login() {
    var username = document.getElementById('username').value;
    var password = document.getElementById('password').value;

    // Basic validation (you should implement actual login logic here)
    if (username === 'admin' && password === 'password') {
        // Successful login, show game category
        showGameCategory();
    } else {
        // Failed login, show error or handle appropriately
